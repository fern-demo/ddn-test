...
1. [docs-starter repository](https://github.com/fern-api/docs-starter/issues) – issues specific to this starter template
     
   a. [Fern repository](https://github.com/fern-api/fern/issues) – general Fern platform bugs and feature requests

           b. [Fern repository](https://github.com/fern-api/fern/issues) – general Fern platform bugs and feature requests
