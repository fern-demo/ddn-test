...
fern generate --docs
```
  1. This will display with a number 1
  2. This will display with a number 2
      1. This will display with a lowercase a
      2. This will display with a lowercase b
          1. This will display with a roman numeral i
          2. This will display with a roman numeral ii
</Step>
</Steps>
